                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="5" name="bionote" value="<?php echo $bionote ?>"><?php echo $bionote ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        ?>
                                            <li class="collection-item ">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <button class="btn btn-danger" type="submit" name="remove_achievement">Remove</button>
                                                </form>
                                            </li>
                                        ...
                                        <li>
                                            <form action="" method="post">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Name of Cert</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Issued Date</label>
                                                            <input type="date" class="form-control" name="issued_date">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Credential Id</label>
                                                            <input type="text" class="form-control" name="credential_id">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Credential URL</label>
                                                            <input type="text" class="form-control" name="credential_url">
                                                        </div>
                                                        <button class="btn btn-primary" type="submit" name="add_achievement">Add Achievement</button>
                                                    </div>
                                            </form>
                                </div>
                                </li>
                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="bmd-label-floating">Field of Study</label>
                                                    ...
                                                    <button class="btn btn-primary" type="submit" name="add_education">Add Education</button>
                                                </div>
                                        </form>
                            </div>
                            </li>
